...
function pythonReservedNames(source) {
...
function topLevelFunctionNames(source) {
    return [...source.matchAll(/^def ([A-Za-z][A-Za-z0-9_]*)\s*\(/gm)].map((match) => match[1]);
}
...
//# sourceMappingURL=repl-reserved-names.test.js.map